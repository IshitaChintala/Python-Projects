...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 13:38:20 2024
...
mr = df['Corrected Apparent Magnitude: r']
...
plt.ylabel(r"$M_{r filter}$", **font,fontsize=35, fontweight='bold', color='w')
plt.title("Mr vs Wmax Plot", **font,fontsize=40, fontweight='bold', color='w')
